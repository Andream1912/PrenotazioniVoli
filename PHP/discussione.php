...
<body class="body">
    ...
    <div class="mid-page">
        ...
        <div class="cardTot" cardTot>
            ...
            <div class="topCard">
                <div class="changingButtonContainer">
                    <?php
                    ...
                    if (!empty($_SESSION['username'])) {
                        if ($_SESSION['username'] == $row['creatore']) {
                            ...
                            echo '<button class="respButton" respButton>Rispondi alla discussione</button>';
                        } else {
                            echo '<button class="respButton" respButton>Rispondi alla discussione</button>';
                        }
                    } else {
                        echo '<button class="logButton" onclick="openLogin()" enterButton>Accedi per partecipare<br>alla discussione</button>';
                    }
                    ?>
                </div>
