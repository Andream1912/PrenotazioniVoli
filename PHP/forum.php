...
<body class="body">
    ...
    <!--Form per la creazione della discussione con funzione js per la validazione-->
        <form action="create-discussion.php" method="GET" class="creator-form" onsubmit="return validateCreateDiscussion()">
            <div class="creator-title">
                ...
                <input type="text" name="discussionTitle" class="creator-discussionTitle" placeholder="Inserisci il titolo..." minlength="8" maxlength="60" discussionTitle>
            </div>
            <div class="creator-text">
                <h1>Descrivi il problema</h1>
                <textarea name="discussionText" class="creator-discussionText" placeholder="Descrivi il problema..." minlength="15" maxlength="600" discussionText></textarea>
            </div>
    ...
    <!--Contenitore superiore della pagina contenente searchbar immmagine e bottone-->
        <div class="top">
                ...
                <div class="imageText"><h1>Come possiamo aiutarti?</h1></div>
                <div class="borderButton">
                    <div class="createButtonContainer">
                    <?php
                        if(!empty($_SESSION['username'])){
                            echo '<button class="create-button" onclick="showDiscussionButton()">Crea discussione</button>';
                        }
                        else{
                    ...
                    <div class="createButtonIcon"><button class="buttonIcon" onclick="showButton()"><i class="fa-solid fa-plus" icon></i></button></div>
                </div>
                    <div class="search">
                    ...
                    <form action="forum.php" method="GET" class="searchForm">
                        <div><input type="text" name="search" class="searchText" placeholder="Cosa cerci?" value="<?php if(isset($_GET['search'])){echo $_GET['search'];} ?>"></div>
