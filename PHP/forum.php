    ...
    <!--Form per la creazione della discussione con funzione js per la validazione-->
        <form action="create-discussion.php" method="GET" class="creator-form" onsubmit="return validateCreateDiscussion()">
            <div class="creator-title">
                ...
                <input type="text" name="discussionTitle" class="creator-discussionTitle" placeholder="Inserisci il titolo..." maxlength="60" discussionTitle>
            </div>
            <div class="creator-text">
                <h1>Descrivi il problema</h1>
                <textarea name="discussionText" class="creator-discussionText" placeholder="Descrivi il problema..." maxlength="600" discussionText></textarea>
            </div>
